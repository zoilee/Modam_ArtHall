...
public class CommentService {
    ...
    public List<CommentEntity> getComments(PerformanceEntity performance, int offset, int limit) {
    ...
    public CommentEntity addComment(UserEntity user, PerformanceEntity performance, String commentText, Integer rating) {
