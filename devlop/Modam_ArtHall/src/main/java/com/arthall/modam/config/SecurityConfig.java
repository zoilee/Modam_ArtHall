...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
            ...
            // 누구나 접근 가능한 경로
            .requestMatchers("/", "/hallDetail", "/findAccount", "/showDetail", "/user/api/**", "/noticeList", "/showDetail/{performanceId}", "/register", "/login", "/find-id", "/find-password", "/css/**", "/js/**", "/imgs/**").permitAll()
            // 로그인 사용자만 접근 가능한 경로
